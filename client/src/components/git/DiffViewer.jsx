import React, { useEffect, useState } from 'antd';
import { Spin, Empty, Select, Switch, Space, Typography } from 'antd';
  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      <div style={{
        ...
        <Title level={5} style={{ margin: 0 }}>{file}</Title>
        <Space>
          <span style={{ fontSize: 12 }}>Split View</span>
          <Switch
            checked={splitView}
